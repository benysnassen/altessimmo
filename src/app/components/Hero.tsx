    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      >
        ...
        <motion.h1 
          ...
          className="font-display text-6xl md:text-8xl font-normal mb-8 leading-none tracking-wider"
        >
          <motion.span
            initial={false}
        ...
        <motion.h2 
          ...
          className="font-display text-4xl md:text-5xl font-normal mb-8 leading-none tracking-wider"
        >
          <motion.span
            initial={false}
            animate={{ opacity: 1, y: 0 }}
